...
void toolbox_load(struct LPMAPI* api)
{
   ...
   LMAPI->register_var("vhost-alias-prefix", NULL, "Maintenance",
     "When creating a new list, add this prefix to all mail aliases.  Useful for Postfix virtusers tables.",
     "vhost-alias-prefix = myhost.", VAR_STRING, VAR_GLOBAL|VAR_SITE);
